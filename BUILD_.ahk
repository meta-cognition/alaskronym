...
version = %A_Now%
version := SubStr(version, 1, 4) . "." . SubStr(version, 5, 2)  . "." . SubStr(version, 7, 2) . " " . SubStr(version, 9, 2) * 60 + SubStr(version, 11, 2) 
rn := "`r`n"
...
msgbox % old_version
FileMove .\_builds\alaskronym_installer_current.exe, % ".\_builds\alaskronym_installer_" old_version ".exe", 1
FileMove .\Installer.exe, .\_builds\alaskronym_installer_current.exe, 1
